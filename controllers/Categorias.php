...
class Categorias extends CI_Controller {
	...
	public function index($id, $slug=null){ /*'slug' é a segunda variavel, por que tem <url-do-site>id/nome-da-categoria (tem que fazer isso pra pegar a primeira apenas) */
