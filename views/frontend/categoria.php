<div class="dh--breadcrumb--area" style="background-image: url(<?= base_url("assets/frontend/assets/img/breadcrumb-bg.jpg") ?>)">
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h4>
                    <?php foreach($titulo_categoria as $nomecat){
                        echo $nomecat->cat_nome;
                    }?>
                </h4>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 st--post--column">
                ...
                <div class="row">
                    <?php
                    foreach ($noticias_filtradas as $not) {
